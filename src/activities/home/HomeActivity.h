...
class HomeActivity final : public Activity {
  ...
  // Long Companion dialogue is paged rather than clipped. Horizontal swipes
  // move through these pages while leaving the normal up/down menu navigation
  // untouched. The page count is learned from whichever theme layout renders.
  int companionMessagePage = 0;
  mutable int companionMessagePages = 1;
